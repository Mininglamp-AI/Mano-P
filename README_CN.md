...
W8A8 配置通过 [Cider](https://github.com/Mininglamp-AI/cider) 实现 INT8 加速。基准测试集涵盖 5 个 Web 应用共 100 条测试用例，详见 [benchmark 方法论](https://github.com/Mininglamp-AI/mano-afk/tree/master/benchmark)。
